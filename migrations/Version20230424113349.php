 ...
 */
final class Version20230424113349 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, editor VARCHAR(255) DEFAULT NULL, collection VARCHAR(255) DEFAULT NULL, summary LONGTEXT DEFAULT NULL, isbn INT DEFAULT NULL, pages SMALLINT DEFAULT NULL, price VARCHAR(64) DEFAULT NULL, image VARCHAR(2048) DEFAULT NULL, publication_date INT DEFAULT NULL, UNIQUE INDEX UNIQ_CBE5A331CC1CF4E6 (isbn), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
